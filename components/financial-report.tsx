                  ...
                  <TableRow key={payment.id} className="border-border hover:bg-muted/50">
                    <TableCell className="font-mono text-xs">
                      <div className="flex flex-col">
                        ...
                        <span className="text-muted-foreground">{format(new Date(payment.timestamp), "HH:mm:ss")}</span>
                      </div>
                    </TableCell>
                    <TableCell>
                      <div className="flex flex-col">
                        <span className="font-medium text-foreground">{payment.vendor?.name || "Unknown Vendor"}</span>
                    ...
                    <TableCell>
                      <div className="flex flex-col">
                        <span className="font-medium text-foreground">${payment.amount_usd?.toFixed(2) || "0.00"}</span>
                      ...
                      <Badge
                        variant={
                          payment.status === "completed" || payment.status === "success"
                            ? "default" // Using default which usually maps to primary color
