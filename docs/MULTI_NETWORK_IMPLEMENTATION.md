...
**Features:**
- ✅ Add new addresses with network auto-detection
- ✅ Edit address labels and primary status
- ✅ Delete addresses (with safety checks)
...
- ✅ Primary and verified indicators
...
- ✅ Search by address, tx hash, vendor
- ✅ Pagination support
- ✅ Block explorer links
- ✅ Network-specific field display (gas/energy)
