 ...
 * 鈹?             TRON Payment Vault Architecture                  鈹?
 ...
 * 鈹? Chain:     TRON Mainnet (mainnet) / Nile Testnet           鈹?
 * 鈹? Asset:     USDT (TRC20), USDC, or any TRC20 token          鈹?
 * 鈹? Security:  Multi-signature + Time-lock + Rate limit         鈹?
 * 鈹? Roles:     Signers, Guardian, Pauser                          鈹?
 * 鈹? Features:  Emergency withdrawal, Daily limit, Replay protect 鈹?
