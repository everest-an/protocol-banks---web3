...
[GPL-3.0-only license](https://github.com/acornjs/acorn/blob/master/acorn/LICENSE).
...
- **onComment**: If a function is passed for this option, whenever a
  ...
  of the comment鈥檚 start and end are passed as two additional
  parameters.
...
- **sourceFile**: When the `locations` option is `true`, you can pass
  this option to add a `source` attribute in every node鈥檚 `loc`
