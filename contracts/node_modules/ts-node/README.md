...
ts-node is licensed under the GPL-3.0-only license.  [GPL-3.0-only](https://github.com/TypeStrong/ts-node/blob/main/LICENSE)

ts-node includes source code from Node.js which is licensed under the GPL-3.0-only license.  [Node.js license information](https://raw.githubusercontent.com/nodejs/node/master/LICENSE)
