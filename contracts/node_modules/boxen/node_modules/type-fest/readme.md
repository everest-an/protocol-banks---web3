...
Either add this package as a dependency or copy-paste the needed types. No credit required. 馃憣
...
- [`CamelCase`](ts41/camel-case.d.ts) 鈥?Convert a string literal to camel-case (`fooBar`).
- [`KebabCase`](ts41/kebab-case.d.ts) 鈥?Convert a string literal to kebab-case (`foo-bar`).
- [`PascalCase`](ts41/pascal-case.d.ts) 鈥?Converts a string literal to pascal-case (`FooBar`)
- [`SnakeCase`](ts41/snake-case.d.ts) 鈥?Convert a string literal to snake-case (`foo_bar`).
- [`DelimiterCase`](ts41/delimiter-case.d.ts) 鈥?Convert a string literal to a custom string delimiter casing.
...
- [`Required<T>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1408-L1413) - Make all properties in `T` required.
	...
	submitContactForm({
			email: 'ex@mple.com',
			message: 'Hi! Could you tell me more about鈥?,
	});
...
- [`ReturnType<T>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1461-L1464) 鈥?Obtain the return type of a function type.
	<details>
	<summary>
			Example
	</summary>
...
- [`InstanceType<T>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1466-L1469) 鈥?Obtain the instance type of a constructor function type.
	<details>
	<summary>
			Example
	</summary>
...
- [`Omit<T, K>`](https://github.com/microsoft/TypeScript/blob/71af02f7459dc812e85ac31365bfe23daf14b4e4/src/lib/es5.d.ts#L1446) 鈥?Constructs a type by picking all properties from T and then removing K.
	<details>
	<summary>
			Example
	</summary>
