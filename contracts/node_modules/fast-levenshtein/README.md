...
var distance = levenshtein.get('鎴戞剾浣?, '鎴戝彨浣?);   // 1
```
...
levenshtein.get('mikailovitch', 'Mikha茂lovitch', { useCollator: true});
// 1
```
...
>> levenshtein-edit-distance x 234 ops/sec 卤3.02% (73 runs sampled)
>> levenshtein-component x 422 ops/sec 卤4.38% (83 runs sampled)
>> levenshtein-deltas x 283 ops/sec 卤3.83% (78 runs sampled)
>> natural x 255 ops/sec 卤0.76% (88 runs sampled)
>> levenshtein x 180 ops/sec 卤3.55% (86 runs sampled)
>> fast-levenshtein x 1,792 ops/sec 卤2.72% (95 runs sampled)
Benchmark done.
...
GPL-3.0-only - see [LICENSE.md](https://github.com/hiddentao/fast-levenshtein/blob/master/LICENSE.md)
