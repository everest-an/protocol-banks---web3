...
```sh
# .makeRe star
  micromatch x 2,232,802 ops/sec 卤2.34% (89 runs sampled))
  minimatch x 781,018 ops/sec 卤6.74% (92 runs sampled))

# .makeRe star; dot=true
  micromatch x 1,863,453 ops/sec 卤0.74% (93 runs sampled)
  minimatch x 723,105 ops/sec 卤0.75% (93 runs sampled)

# .makeRe globstar
  micromatch x 1,624,179 ops/sec 卤2.22% (91 runs sampled)
  minimatch x 1,117,230 ops/sec 卤2.78% (86 runs sampled))

# .makeRe globstars
  micromatch x 1,658,642 ops/sec 卤0.86% (92 runs sampled)
  minimatch x 741,224 ops/sec 卤1.24% (89 runs sampled))

# .makeRe with leading star
  micromatch x 1,525,014 ops/sec 卤1.63% (90 runs sampled)
  minimatch x 561,074 ops/sec 卤3.07% (89 runs sampled)

# .makeRe - braces
  micromatch x 172,478 ops/sec 卤2.37% (78 runs sampled)
  minimatch x 96,087 ops/sec 卤2.34% (88 runs sampled)))

# .makeRe braces - range (expanded)
  micromatch x 26,973 ops/sec 卤0.84% (89 runs sampled)
  minimatch x 3,023 ops/sec 卤0.99% (90 runs sampled))

# .makeRe braces - range (compiled)
  micromatch x 152,892 ops/sec 卤1.67% (83 runs sampled)
  minimatch x 992 ops/sec 卤3.50% (89 runs sampled)d))

# .makeRe braces - nested ranges (expanded)
  micromatch x 15,816 ops/sec 卤13.05% (80 runs sampled)
  minimatch x 2,953 ops/sec 卤1.64% (91 runs sampled)

# .makeRe braces - nested ranges (compiled)
  micromatch x 110,881 ops/sec 卤1.85% (82 runs sampled)
  minimatch x 1,008 ops/sec 卤1.51% (91 runs sampled)

# .makeRe braces - set (compiled)
  micromatch x 134,930 ops/sec 卤3.54% (63 runs sampled))
  minimatch x 43,242 ops/sec 卤0.60% (93 runs sampled)

# .makeRe braces - nested sets (compiled)
  micromatch x 94,455 ops/sec 卤1.74% (69 runs sampled))
  minimatch x 27,720 ops/sec 卤1.84% (93 runs sampled))
```
...
* [braces](https://www.npmjs.com/package/braces): Bash-like brace expansion, implemented in JavaScript. Safer than other brace expansion libs, with complete support鈥?[more](https://github.com/micromatch/braces) | [homepage](https://github.com/micromatch/braces "Bash-like brace expansion, implemented in JavaScript. Safer than other brace expansion libs, with complete support for the Bash 4.3 braces specification, without sacrificing speed.")
...
* [extglob](https://www.npmjs.com/package/extglob): Extended glob support for JavaScript. Adds (almost) the expressive power of regular expressions to glob鈥?[more](https://github.com/micromatch/extglob) | [homepage](https://github.com/micromatch/extglob "Extended glob support for JavaScript. Adds (almost) the expressive power of regular expressions to glob patterns.")
* [fill-range](https://www.npmjs.com/package/fill-range): Fill in a range of numbers or letters, optionally passing an increment or `step` to鈥?[more](https://github.com/jonschlinkert/fill-range) | [homepage](https://github.com/jonschlinkert/fill-range "Fill in a range of numbers or letters, optionally passing an increment or `step` to use, or create a regex-compatible range with `options.toRegex`")
* [nanomatch](https://www.npmjs.com/package/nanomatch): Fast, minimal glob matcher for node.js. Similar to micromatch, minimatch and multimatch, but complete Bash鈥?[more](https://github.com/micromatch/nanomatch) | [homepage](https://github.com/micromatch/nanomatch "Fast, minimal glob matcher for node.js. Similar to micromatch, minimatch and multimatch, but complete Bash 4.3 wildcard support only (no support for exglobs, posix brackets or braces)")
...
Copyright 漏 2024, [Jon Schlinkert](https://github.com/jonschlinkert).
