...
- 馃敀 [**Audited**](#security) by an independent security firm: no vulnerabilities have been found
- 馃敾 Tree-shaking-friendly: there is no entry point, which ensures small size of your app
...
- 馃攳 Unique tests ensure correctness: chained tests, sliding window tests, DoS tests
- 馃И Differential fuzzing ensures even more correctness with [cryptofuzz](https://github.com/guidovranken/cryptofuzz)
...
- 馃 K12 ([KangarooTwelve Paper](https://keccak.team/files/KangarooTwelve.pdf), [RFC Draft](https://www.ietf.org/archive/id/draft-irtf-cfrg-kangarootwelve-06.txt)) and M14 aka MarsupilamiFourteen are basically parallel versions of Keccak with reduced number of rounds (same as Blake3 and ParallelHash).
...
SHA384 32B x 463,606 ops/sec @ 2渭s/op
SHA512 32B x 467,945 ops/sec @ 2渭s/op
SHA3-256, keccak256, shake256 32B x 192,049 ops/sec @ 5渭s/op
Kangaroo12 32B x 318,066 ops/sec @ 3渭s/op
Marsupilami14 32B x 283,929 ops/sec @ 3渭s/op
BLAKE2b 32B x 352,112 ops/sec @ 2渭s/op
BLAKE2s 32B x 511,770 ops/sec @ 1渭s/op
BLAKE3 32B x 582,072 ops/sec @ 1渭s/op
RIPEMD160 32B x 1,230,012 ops/sec @ 813ns/op
HMAC-SHA256 32B x 238,663 ops/sec @ 4渭s/op
...
SHA384 32B native x 938,086 ops/sec @ 1渭s/op
SHA512 32B native x 946,969 ops/sec @ 1渭s/op
SHA3 32B native x 879,507 ops/sec @ 1渭s/op
keccak, k12, m14 are not implemented
BLAKE2b 32B native x 879,507 ops/sec @ 1渭s/op
BLAKE2s 32B native x 977,517 ops/sec @ 1渭s/op
BLAKE3 is not implemented
RIPEMD160 32B native x 913,242 ops/sec @ 1渭s/op
HMAC-SHA256 32B native x 755,287 ops/sec @ 1渭s/op
HKDF-SHA256 32B native x 207,856 ops/sec @ 4渭s/op
