...
* install the dependencies 鈥?`npm i`
* do your changes to the code
* build the TronWeb dist files 鈥?`npm run build:all`
* run a local private network using Tron Quickstart
* run the tests 鈥?`npm run test`
...
TronWeb is distributed under a GPL-3.0-only licence.
