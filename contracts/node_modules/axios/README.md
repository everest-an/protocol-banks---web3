...
- [馃啎 Rate limiting](#-rate-limiting)
...
- **Form Serialization:** 馃啎 Automatically serializes data objects to `multipart/form-data` or `x-www-form-urlencoded` formats.
...
|                                                    Latest 鉁?                                                   |                                                     Latest 鉁?                                                     |                                                    Latest 鉁?                                                   |                                                  Latest 鉁?                                                  |                                                 Latest 鉁?                                                |
...
async function fetchWithTimeout() {
  try {
    ...
    if (axios.isAxiosError(error) && error.code === "ECONNABORTED") {
      console.error("鉂?Request timed out!");
    } else {
...
[![License: GPL-3.0-only](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
