...
- 馃敀 [**Audited**](#security) by independent security firms
- 馃敾 Tree-shakeable: unused code is excluded from your builds
- 馃弾 Fast: hand-optimized for caveats of JS engines
- 馃攳 Reliable: cross-library / wycheproof tests and fuzzing ensure correctness
- 鉃?Short Weierstrass, Edwards, Montgomery curves
- 鉁嶏笍 ECDSA, EdDSA, Schnorr, BLS, ECDH, hashing to curves, Poseidon ZK-friendly hash
- 馃敄 SUF-CMA, SBS (non-repudiation), ZIP215 (consensus friendliness) features for ed25519 & ed448
- 馃 93KB for everything with hashes, 26KB (11KB gzipped) for single-curve build
...
> **noble cryptography** 鈥?high-security, easily auditable set of contained cryptographic libraries and tools.
...
Short Weierstrass curve's formula is `y虏 = x鲁 + ax + b`. `weierstrass`
...
- Are represented in projective (homogeneous) coordinates: (x, y, z) 鈭?(x=x/z, y=y/z)
...
Twisted Edwards curve's formula is `ax虏 + y虏 = 1 + dx虏y虏`.
...
- Are represented in extended coordinates: (x, y, z, t) 鈭?(x=x/z, y=y/z)
- Use complete exception-free formulas for addition and doubling
...
which may leak exponent bits, when used na茂vely.
...
for some cases. If your goal is absolute security, don't use any JS lib 鈥?including bindings to native ones.
...
# secp256k1
init 10ms
getPublicKey x 9,099 ops/sec @ 109渭s/op
sign x 7,182 ops/sec @ 139渭s/op
verify x 1,188 ops/sec @ 841渭s/op
getSharedSecret x 735 ops/sec @ 1ms/op
recoverPublicKey x 1,265 ops/sec @ 790渭s/op
schnorr.sign x 957 ops/sec @ 1ms/op
schnorr.verify x 1,210 ops/sec @ 825渭s/op

# ed25519
init 14ms
getPublicKey x 14,216 ops/sec @ 70渭s/op
sign x 6,849 ops/sec @ 145渭s/op
verify x 1,400 ops/sec @ 713渭s/op

# ed448
init 37ms
getPublicKey x 5,273 ops/sec @ 189渭s/op
sign x 2,494 ops/sec @ 400渭s/op
verify x 476 ops/sec @ 2ms/op

# p256
init 17ms
getPublicKey x 8,977 ops/sec @ 111渭s/op
sign x 7,236 ops/sec @ 138渭s/op
verify x 877 ops/sec @ 1ms/op

# p384
init 42ms
getPublicKey x 4,084 ops/sec @ 244渭s/op
sign x 3,247 ops/sec @ 307渭s/op
verify x 331 ops/sec @ 3ms/op

# p521
init 83ms
getPublicKey x 2,049 ops/sec @ 487渭s/op
sign x 1,748 ops/sec @ 571渭s/op
verify x 170 ops/sec @ 5ms/op

# ristretto255
add x 931,966 ops/sec @ 1渭s/op
multiply x 15,444 ops/sec @ 64渭s/op
encode x 21,367 ops/sec @ 46渭s/op
decode x 21,715 ops/sec @ 46渭s/op

# decaf448
add x 478,011 ops/sec @ 2渭s/op
multiply x 416 ops/sec @ 2ms/op
encode x 8,562 ops/sec @ 116渭s/op
decode x 8,636 ops/sec @ 115渭s/op

# ECDH
x25519 x 1,981 ops/sec @ 504渭s/op
...
hash_to_field x 135,703 ops/sec @ 7渭s/op
hashToCurve secp256k1 x 3,194 ops/sec @ 313渭s/op
hashToCurve p256 x 5,962 ops/sec @ 167渭s/op
hashToCurve p384 x 2,230 ops/sec @ 448渭s/op
hashToCurve p521 x 1,063 ops/sec @ 940渭s/op
hashToCurve ed25519 x 4,047 ops/sec @ 247渭s/op
hashToCurve ed448 x 1,691 ops/sec @ 591渭s/op
hash_to_ristretto255 x 8,733 ops/sec @ 114渭s/op
hash_to_decaf448 x 3,882 ops/sec @ 257渭s/op

# modular over secp256k1 P field
invert a x 866,551 ops/sec @ 1渭s/op
invert b x 693,962 ops/sec @ 1渭s/op
sqrt p = 3 mod 4 x 25,738 ops/sec @ 38渭s/op
sqrt tonneli-shanks x 847 ops/sec @ 1ms/op

# bls12-381
init 22ms
getPublicKey x 1,325 ops/sec @ 754渭s/op
sign x 80 ops/sec @ 12ms/op
verify x 62 ops/sec @ 15ms/op
pairing x 166 ops/sec @ 6ms/op
pairing10 x 54 ops/sec @ 18ms/op 卤 23.48% (15ms..36ms)
...
The GPL-3.0-only License (GPL-3.0-only)
