 ...
 */
function lift_x(x) {
    (0, utils_ts_1.aInRange)('x', x, _1n, secp256k1P); // Fail if x 鈮?p.
    const xx = modP(x * x);
...
function schnorrVerify(signature, message, publicKey) {
    ...
    try {
        ...
        const r = num(sig.subarray(0, 32)); // Let r = int(sig[0:32]); fail if r 鈮?p.
        if (!(0, utils_ts_1.inRange)(r, _1n, secp256k1P))
            return false;
        const s = num(sig.subarray(32, 64)); // Let s = int(sig[32:64]); fail if s 鈮?n.
