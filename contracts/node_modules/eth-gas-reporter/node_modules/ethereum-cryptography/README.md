...
The implementation is [loosely based on hdkey, which has GPL-3.0-only License](#LICENSE).
...
`ethereum-cryptography` is released under The GPL-3.0-only License (GPL-3.0-only)
...
which had [GPL-3.0-only License](https://github.com/cryptocoinjs/hdkey/blob/3f3c0b5cedb98f971835b5116ebea05b3c09422a/LICENSE)
