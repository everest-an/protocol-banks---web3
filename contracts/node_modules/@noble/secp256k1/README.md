...
- `privateKey: Uint8Array | string | bigint` - private key which will sign the hash
- `auxilaryRandom?: Uint8Array` 鈥?optional 32 random bytes. By default, the method gathers cryptogarphically secure entropy
...
Benchmarks measured with Apple M2 on MacOS 12 with node.js 18.8.
    ...
    getPublicKey(utils.randomPrivateKey()) x 7,093 ops/sec @ 140渭s/op
    sign x 5,615 ops/sec @ 178渭s/op
    signSync (@noble/hashes) x 5,209 ops/sec @ 191渭s/op
    verify x 1,114 ops/sec @ 896渭s/op
    recoverPublicKey x 1,018 ops/sec @ 982渭s/op
    getSharedSecret aka ecdh x 665 ops/sec @ 1ms/op
    getSharedSecret (precomputed) x 7,426 ops/sec @ 134渭s/op
    Point.fromHex (decompression) x 14,582 ops/sec @ 68渭s/op
    schnorr.sign x 805 ops/sec @ 1ms/op
    schnorr.verify x 1,129 ops/sec @ 885渭s/op
...
GPL-3.0-only (c) Paul Miller [(https://paulmillr.com)](https://paulmillr.com), see LICENSE file.
