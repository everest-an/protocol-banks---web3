...
- 馃攳 Unique tests ensure correctness: chained tests, sliding window tests, DoS tests, fuzzing
- 馃攣 No unrolled loops: makes it easier to verify and reduces source code size up to 5x
- 馃悽 Scrypt supports `N: 2**22`, while other implementations are limited to `2**20`
- 馃 SHA3 supports Keccak, TupleHash, KangarooTwelve and MarsupilamiFourteen
- 馃 Just 3.4k lines / 17KB gzipped. SHA256-only is 240 lines / 3KB gzipped
...
- 馃 K12 ([KangarooTwelve Paper](https://keccak.team/files/KangarooTwelve.pdf),
...
3. [Timing attack](https://en.wikipedia.org/wiki/Timing_attack) considerations:
   ...
   for some cases. If your goal is absolute security, don't use any JS lib 鈥?including
...
```
SHA256 32B x 1,219,512 ops/sec @ 820ns/op 卤 2.58% (min: 625ns, max: 4ms)
SHA384 32B x 512,032 ops/sec @ 1渭s/op
SHA512 32B x 509,943 ops/sec @ 1渭s/op
SHA3-256, keccak256, shake256 32B x 199,600 ops/sec @ 5渭s/op
Kangaroo12 32B x 336,360 ops/sec @ 2渭s/op
Marsupilami14 32B x 298,418 ops/sec @ 3渭s/op
BLAKE2b 32B x 379,794 ops/sec @ 2渭s/op
BLAKE2s 32B x 515,995 ops/sec @ 1渭s/op 卤 1.07% (min: 1渭s, max: 4ms)
BLAKE3 32B x 588,235 ops/sec @ 1渭s/op 卤 1.36% (min: 1渭s, max: 5ms)
RIPEMD160 32B x 1,140,250 ops/sec @ 877ns/op 卤 3.12% (min: 708ns, max: 6ms)
HMAC-SHA256 32B x 377,358 ops/sec @ 2渭s/op

HKDF-SHA256 32B x 108,377 ops/sec @ 9渭s/op
...
```
SHA256 32B node x 1,302,083 ops/sec @ 768ns/op 卤 10.54% (min: 416ns, max: 7ms)
SHA384 32B node x 975,609 ops/sec @ 1渭s/op 卤 11.32% (min: 625ns, max: 8ms)
SHA512 32B node x 983,284 ops/sec @ 1渭s/op 卤 11.24% (min: 625ns, max: 8ms)
SHA3-256 32B node x 910,746 ops/sec @ 1渭s/op 卤 12.19% (min: 666ns, max: 10ms)
keccak, k12, m14 are not implemented
BLAKE2b 32B node x 967,117 ops/sec @ 1渭s/op 卤 11.26% (min: 625ns, max: 9ms)
BLAKE2s 32B node x 1,055,966 ops/sec @ 947ns/op 卤 11.07% (min: 583ns, max: 7ms)
BLAKE3 is not implemented
RIPEMD160 32B node x 1,002,004 ops/sec @ 998ns/op 卤 10.66% (min: 625ns, max: 7ms)
HMAC-SHA256 32B node x 919,963 ops/sec @ 1渭s/op 卤 6.13% (min: 833ns, max: 5ms)
HKDF-SHA256 32 node x 369,276 ops/sec @ 2渭s/op 卤 13.59% (min: 1渭s, max: 9ms)
