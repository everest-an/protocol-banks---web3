...
// Constant-time ratio of u to v. Allows to combine inversion and square root u/鈭歷.
...
function uvRatio(u, v) {
    ...
    // x = (u/v)^((p+1)/4)   = u鲁v(u鈦祐鲁)^((p-3)/4)   (mod p)
    const u2v = (0, modular_js_1.mod)(u * u * v, P); // u虏v
    const u3v = (0, modular_js_1.mod)(u2v * u, P); // u鲁v
    const u5v3 = (0, modular_js_1.mod)(u3v * u2v * v, P); // u鈦祐鲁
    const root = ed448_pow_Pminus3div4(u5v3);
    const x = (0, modular_js_1.mod)(u3v * root, P);
    // Verify that root is exists
    const x2 = (0, modular_js_1.mod)(x * x, P); // x虏
    // If vx虏 = u, the recovered x-coordinate is x.  Otherwise, no
...
const ED448_DEF = {
    ...
    // Finite field 饾斀p over which we'll do calculations; 2n**448n - 2n**224n - 1n
    Fp,
