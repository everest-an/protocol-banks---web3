...
- 馃敀 [**Audited**](#security) by an independent security firm
- 馃敾 Tree-shaking-friendly: use only what's necessary, other code won't be included
- 馃弾 Ultra-fast, hand-optimized for caveats of JS engines
- 馃攳 Unique tests ensure correctness: property-based, cross-library and Wycheproof vectors, fuzzing
- 鉃?Short Weierstrass, Edwards, Montgomery curves
- 鉁嶏笍 ECDSA, EdDSA, Schnorr, BLS signature schemes, ECDH key agreement
- 馃敄 SUF-CMA and SBS (non-repudiation) for ed25519, ed448 and others
- #锔忊儯 hash-to-curve for encoding or hashing an arbitrary string to an elliptic curve point
- 馃鈥嶁檪锔?Poseidon ZK-friendly hash

### This library belongs to _noble_ crypto

> **noble-crypto** 鈥?high-security, easily auditable set of contained cryptographic libraries and tools.
...
2. Represented in projective (homogeneous) coordinates: (x, y, z) 鈭?(x=x/z, y=y/z)
...
Twisted Edwards curve's formula is `ax虏 + y虏 = 1 + dx虏y虏`. You must specify `a`, `d`, field `Fp`, order `n`, cofactor `h`
and coordinates `Gx`, `Gy` of generator point.
...
2. Represented in extended coordinates: (x, y, z, t) 鈭?(x=x/z, y=y/z)
3. Use complete exception-free formulas for addition and doubling
...
getPublicKey x 6,750 ops/sec @ 148渭s/op
sign x 5,206 ops/sec @ 192渭s/op
...
getPublicKey x 6,530 ops/sec @ 153渭s/op
sign x 5,074 ops/sec @ 197渭s/op
verify x 626 ops/sec @ 1ms/op

p384
init x 17 ops/sec @ 57ms/op
getPublicKey x 2,883 ops/sec @ 346渭s/op
sign x 2,358 ops/sec @ 424渭s/op
verify x 245 ops/sec @ 4ms/op

p521
init x 9 ops/sec @ 109ms/op
getPublicKey x 1,516 ops/sec @ 659渭s/op
sign x 1,271 ops/sec @ 786渭s/op
verify x 123 ops/sec @ 8ms/op

ed25519
init x 54 ops/sec @ 18ms/op
getPublicKey x 10,269 ops/sec @ 97渭s/op
sign x 5,110 ops/sec @ 195渭s/op
verify x 1,049 ops/sec @ 952渭s/op

ed448
init x 19 ops/sec @ 51ms/op
getPublicKey x 3,775 ops/sec @ 264渭s/op
sign x 1,771 ops/sec @ 564渭s/op
verify x 351 ops/sec @ 2ms/op

ecdh
鈹溾攢x25519 x 1,466 ops/sec @ 682渭s/op
鈹溾攢secp256k1 x 539 ops/sec @ 1ms/op
鈹溾攢p256 x 511 ops/sec @ 1ms/op
鈹溾攢p384 x 199 ops/sec @ 5ms/op
鈹溾攢p521 x 103 ops/sec @ 9ms/op
鈹斺攢x448 x 548 ops/sec @ 1ms/op
...
hash-to-curve
hash_to_field x 91,600 ops/sec @ 10渭s/op
secp256k1 x 2,373 ops/sec @ 421渭s/op
p256 x 4,310 ops/sec @ 231渭s/op
p384 x 1,664 ops/sec @ 600渭s/op
p521 x 807 ops/sec @ 1ms/op
ed25519 x 3,088 ops/sec @ 323渭s/op
ed448 x 1,247 ops/sec @ 801渭s/op
```
...
- EdDSA
  ...
  - [It鈥檚 255:19AM. Do you know what your validation criteria are?](https://hdevalence.ca/blog/2020-10-04-its-25519am)
  ...
  - [Cofactor Explained: Clearing Elliptic Curves鈥?dirty little secret](https://loup-vaillant.fr/tutorials/cofactor)
