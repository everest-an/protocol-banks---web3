...
- 馃敀 [**Audited**](#security) by an independent security firms
- 馃敾 Tree-shakeable: unused code is excluded from your builds
- 馃弾 Fast: hand-optimized for caveats of JS engines
- 馃攳 Reliable: property-based / cross-library / wycheproof tests and fuzzing ensure correctness
- 鉃?Short Weierstrass, Edwards, Montgomery curves
- 鉁嶏笍 ECDSA, EdDSA, Schnorr, BLS signature schemes, ECDH key agreement, hashing to curves
- 馃敄 SUF-CMA, SBS (non-repudiation), ZIP215 (consensus friendliness) features for ed25519
- 馃鈥嶁檪锔?Poseidon ZK-friendly hash
- 馃 178KB (87KB gzipped) for everything including bundled hashes, 22KB (10KB gzipped) for single-curve build
