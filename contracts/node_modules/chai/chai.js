...
module.exports = function (chai, _) {
   ...
   * asserting that it鈥檚 not an `arguments` object.
   *
   *     expect('foo').to.be.a('string'); // Recommended
   ...
   * given key `name` but it鈥檚 not deeply equal to the given `descriptor`. It's
...
(function (global, factory) {
  ...
  var baseTypesMap = {
    ...
    WeakSet: function WeakSet(value, options) {
      return options.stylize('WeakSet{鈥', 'special');
    },
    WeakMap: function WeakMap(value, options) {
      return options.stylize('WeakMap{鈥', 'special');
    },
