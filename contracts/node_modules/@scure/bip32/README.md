...
- 馃摝 ESM and common.js
- 鉃?Only 3 audited dependencies by the same author:
  [noble-curves](https://github.com/paulmillr/noble-curves),
  [noble-hashes](https://github.com/paulmillr/noble-hashes),
  and [scure-base](https://github.com/paulmillr/scure-base)
- 馃 300 lines. 90KB with all dependencies
...
> **scure** 鈥?audited micro-libraries.
...
The implementation is loosely based on cryptocoinjs/hdkey, [which has GPL-3.0-only License](#LICENSE).
