...
<p align="center">
  ...
  <sub>>_ Prompts should be more like conversations than inquisitions鈻?/sub>
</p>
...
<p align="center">
  <b>>_ Ready to start making prompts your users will love? 鈻?/b><br>
...
**Jump to**: [Getting Started](#-getting-started) 路 [Prompts](#-prompts) 路 [Options](#prompt-options) 路 [Key Bindings](#-key-bindings)
...
**鈫?back to:** [Getting Started](#-getting-started) 路 [Prompts](#-prompts)
...
| **Method** | **Description** |
| --- | --- |
| `pointer()` | Returns the visual symbol to use to identify the choice that currently has focus. The `鉂痐 symbol is often used for this. The pointer is not always visible, as with the `autocomplete` prompt. |
...
Copyright 漏 2018-present, [Jon Schlinkert](https://github.com/jonschlinkert).
