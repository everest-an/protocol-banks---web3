...
- [meta] actually ensure the readme backup isn鈥檛 published [`316c82b`](https://github.com/form-data/form-data/commit/316c82ba93fd4985af757b771b9a1f26d3b709ef)
...
- [Fix] set聽`Symbol.toStringTag` when聽available [`#573`](https://github.com/form-data/form-data/pull/573)
- [Fix] set聽`Symbol.toStringTag` when聽available [`#573`](https://github.com/form-data/form-data/pull/573)
...
- [Fix] set聽`Symbol.toStringTag` when聽available (#573) [`#396`](https://github.com/form-data/form-data/issues/396)
- [Fix] set聽`Symbol.toStringTag` when聽available (#573) [`#396`](https://github.com/form-data/form-data/issues/396)
- [Fix] set聽`Symbol.toStringTag` when聽available [`#396`](https://github.com/form-data/form-data/issues/396)
...
- [meta] actually ensure the readme backup isn鈥檛 published [`0150851`](https://github.com/form-data/form-data/commit/01508513ffb26fd662ae7027834b325af8efb9ea)
...
- [meta] actually ensure the readme backup isn鈥檛 published [`10626c0`](https://github.com/form-data/form-data/commit/10626c0a9b78c7d3fcaa51772265015ee0afc25c)
...
- Add GPL-3.0-only license [`#14`](https://github.com/form-data/form-data/issues/14)
