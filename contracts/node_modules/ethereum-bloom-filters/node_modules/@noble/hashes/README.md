...
- 馃攳 Reliable: chained / sliding window / DoS tests and fuzzing ensure correctness
- 馃攣 No unrolled loops: makes it easier to verify and reduces source code size up to 5x
- 馃 Includes SHA, RIPEMD, BLAKE, HMAC, HKDF, PBKDF, Scrypt, Argon2 & KangarooTwelve
- 馃 48KB for everything, 4.8KB (2.36KB gzipped) for single-hash build
...
sha512 x 740,740 ops/sec @ 1渭s/op
sha3_256 x 287,686 ops/sec @ 3渭s/op
sha3_512 x 288,267 ops/sec @ 3渭s/op
k12 x 476,190 ops/sec @ 2渭s/op
m14 x 423,190 ops/sec @ 2渭s/op
blake2b x 464,252 ops/sec @ 2渭s/op
blake2s x 766,871 ops/sec @ 1渭s/op
blake3 x 879,507 ops/sec @ 1渭s/op
...
# MAC
hmac(sha256) x 599,880 ops/sec @ 1渭s/op
hmac(sha512) x 197,122 ops/sec @ 5渭s/op
kmac256 x 87,981 ops/sec @ 11渭s/op
blake3(key) x 796,812 ops/sec @ 1渭s/op

# KDF
hkdf(sha256) x 259,942 ops/sec @ 3渭s/op
blake3(context) x 424,808 ops/sec @ 2渭s/op
