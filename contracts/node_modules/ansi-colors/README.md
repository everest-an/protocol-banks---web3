...
```
# All Colors
  ansi-colors x 173,851 ops/sec 卤0.42% (91 runs sampled)
  chalk x 9,944 ops/sec 卤2.53% (81 runs sampled)))

# Chained colors
  ansi-colors x 20,791 ops/sec 卤0.60% (88 runs sampled)
  chalk x 2,111 ops/sec 卤2.34% (83 runs sampled)

# Nested colors
  ansi-colors x 59,304 ops/sec 卤0.98% (92 runs sampled)
  chalk x 4,590 ops/sec 卤2.08% (82 runs sampled)
```
...
```
# All Colors
  ansi-colors x 193,088 ops/sec 卤0.51% (95 runs sampled))
  chalk x 9,612 ops/sec 卤3.31% (77 runs sampled)))

# Chained colors
  ansi-colors x 26,093 ops/sec 卤1.13% (94 runs sampled)
  chalk x 2,267 ops/sec 卤2.88% (80 runs sampled))

# Nested colors
  ansi-colors x 67,747 ops/sec 卤0.49% (93 runs sampled)
  chalk x 4,446 ops/sec 卤3.01% (82 runs sampled))
```
...
Copyright 漏 2019, [Brian Woodward](https://github.com/doowb).
