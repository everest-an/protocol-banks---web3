<p align="center">
  ...
  <p align="center">馃攲 TypeScript bindings for Ethereum smart contracts</p>
  ...
  <p align="center">
    <strong>馃捀 Enjoy using TypeChain? Consider funding development via <a href="https://gitcoin.co/grants/4038/deth-typechain">GitCoin</a> 馃捀</strong>
  </p>
...
A: _NO_ 鈥?we believe that no generated files should go to git repository. You should git ignore them and make
...
Kris Kaczor (krzkaczor) GPL-3.0-only | [Github](https://github.com/krzkaczor) | [Twitter](https://twitter.com/krzkaczor)
