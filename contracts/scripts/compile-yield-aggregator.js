...
const contractFiles = [
    ...
    'contracts/tron/IJustLend.sol',
    'contracts/tron/TronYieldAggregator.sol'
];
...
const input = {
    ...
    settings: {
        ...
        viaIR: true  // Enable viaIR for better handling of complex contracts
    }
};

console.log('Compiling TronYieldAggregator...');
...
if (output.errors) {
    ...
    output.errors.forEach(error => {
        console.error(`Severity: ${error.severity} - ${error.formattedMessage}`);
    });
