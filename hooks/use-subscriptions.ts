...
const DEMO_SUBSCRIPTIONS: Subscription[] = [
  ...
  // Tron-based subscriptions
  {
    id: "8",
    service_name: "Asia Supplier Payment",
    recipient_address: "TSupplier123...",
    amount: "5000",
    token: "USDT",
    chain: "Tron",
    frequency: "monthly",
    status: "active",
    max_amount: "6000",
    next_payment: "2027-04-10",
    last_payment: "2027-03-10",
    created_by: "demo",
    created_at: "2027-02-10",
    updated_at: "2027-03-10",
    use_case: "enterprise",
    max_authorized_amount: "60000",
    authorization_expires_at: "2027-12-31",
    total_paid: "10000",
    payment_count: 2,
    schedule_day: 10,
    ...
    description: "Monthly payment to Asia-based supplier via TRC20",
    remaining_quota: "50000",
    authorization_valid: true,
  },
  {
    id: "9",
    service_name: "Freelancer Payout (Tron)",
    recipient_address: "TFreelancer...",
    amount: "800",
    token: "USDT",
    chain: "Tron",
    frequency: "weekly",
    status: "active",
    max_amount: "1000",
    next_payment: "2027-03-24",
    last_payment: "2027-03-17",
    created_by: "demo",
    created_at: "2027-03-01",
    updated_at: "2027-03-17",
    use_case: "individual",
  },
]
