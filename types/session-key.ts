...
export const SUPPORTED_CHAINS: Record<number, ChainConfig> = {
  ...
  8453: {
    ...
    contractAddress: process.env.NEXT_PUBLIC_SESSION_KEY_BASE || "0xD21da938D95188f642b904360019b38017418578",
  ...
  177: {
    chainId: 177,
    name: "HashKey Chain",
    rpcUrl: process.env.NEXT_PUBLIC_HASHKEY_RPC || "https://mainnet.hsk.xyz",
    contractAddress: process.env.NEXT_PUBLIC_SESSION_KEY_HASHKEY || "0x443A86f4a85a03250E580e943AF6038aBDCb2b5e",
